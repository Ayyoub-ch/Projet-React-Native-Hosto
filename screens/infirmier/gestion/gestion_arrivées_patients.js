...
export default function Gestion_Arrivees_Patients({ navigation }) {
  ...
  const rows = useMemo(() => {
    const source = todayOnly ? sejours.filter((sejour) => isToday(sejour.dateEntree)) : sejours;
    return source;
  }, [sejours, todayOnly]);

  const validateArrival = (sejourId) => {
    ...
    <View style={styles.container}>
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <Text style={styles.cardTitle}>Gerer les arrivees des patients</Text>
        </View>

        <View style={styles.cardBody}>
          <View style={[styles.actionsTop, styles.spacingBottom]}>
            <Pressable
            ...
            >
              <Text style={styles.btnTextLight}>
                {todayOnly ? "Afficher toutes les arrivees" : "Afficher les arrivees du jour"}
              </Text>
            </Pressable>
          </View>
                    ...
                    return (
                      <View key={sejour.id} style={styles.tableRow}>
                        ...
                        <View style={[styles.cell, styles.wActions, styles.actionsCell]}>
                          ...
                          {validated ? (
                            <Text style={styles.validatedText}>Arrivee validee</Text>
                          ) : (
                            <Pressable
                              style={({ pressed }) => [styles.btn, styles.btnSuccess, pressed && styles.btnSuccessPressed]}
                              onPress={() => validateArrival(sejour.id)}
                            >
                              <Text style={styles.btnTextLight}>Valider arrivee</Text>
                            </Pressable>
                          )}
                        </View>
                      </View>
